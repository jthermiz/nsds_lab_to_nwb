...
class HTKReader:
    ...
    def __init__(self, path, dev_conf, channels=None):
        self.path = path
        self.device_reader = EPhysInstrumentData(
            htkdir=self.path,
    ...
    def get_data(self, stream):
        ...
        """
        self.device_reader.read_data(create_iterator=True, time_axis_first=True, has_bands=False)

        data = self.device_reader.data
        meta = {}
        meta['sample_rate'] = self.device_reader.sample_rate
        return data, meta
